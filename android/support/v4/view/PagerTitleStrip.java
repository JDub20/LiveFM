  ...
  implements ViewPager.Decor
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (m == 1073741824)
    {
      ...
      int i2 = j - i1;
      m = View.MeasureSpec.makeMeasureSpec((int)(0.8F * k), -2147483648);
  ...
  void updateTextPositions(int paramInt, float paramFloat, boolean paramBoolean)
  {
    ...
    int i8 = Math.max(Math.max(i6, i7), i9);
    i6 = i8 - i6;
    i7 = i8 - i7;
    i8 -= i9;
    int i10 = i6 + this.mPrevText.getMeasuredHeight();
    i9 = i7 + this.mCurrText.getMeasuredHeight();
    int i11 = i8 + this.mNextText.getMeasuredHeight();
    i9 = Math.max(Math.max(i10, i9), i11);
